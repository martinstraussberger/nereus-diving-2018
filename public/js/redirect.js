...
document.getElementById('redirect-fernsteinsee').onclick = function redirectFernSteinSee() {
	window.location.href = 'pages/partners/Fernsteinsee.html';
};

// redirect to Bunaken
document.getElementById('redirect-bunaken').onclick = function redirectBunaken() {
	window.location.href = 'pages/partners/Bunaken.html';
};
